            ...
            if default_input == 1:
                ...
                if logged_in:
                    ...
                    if login_menu == 1:
                        ...
                        print()
                        password_Storage_and_Retrieval_class.getAllPasswords(username, master_password_get_all_password, key)
                        ...
                        if validate == 'y':
                            password_Storage_and_Retrieval_class.removeAccount(accountName_delete_password, username_delete_password)
